    ...
    <div className="min-h-screen flex" style={{ background: "var(--ep-bg)" }}>
      ...
      >
        ...
        <div className="relative">
          ...
          <h1 className="font-display text-[38px] leading-[1.08] mb-4" style={{ color: "#EAF0FA" }}>
            Every seat allotment,<br />
            <span style={{ color: "var(--color-ep-green)" }}>backed by data.</span>
          </h1>
          <p className="text-[15px] leading-relaxed max-w-sm mb-8" style={{ color: "#B7C7DE" }}>
            Sign in to pick up your students right where you left off — predictions, shortlists, and CAP strategy in one place.
          </p>
          <PathMeter safe={40} probable={35} reach={25} dark className="max-w-xs" />
        </div>

        <div className="relative flex items-center gap-6 text-[13px]" style={{ color: "#8FA6C4" }}>
          <span><b className="font-mono text-[15px] font-semibold" style={{ color: "#EAF0FA" }}>408</b> colleges</span>
          <span style={{ color: "#22385C" }}>·</span>
          <span><b className="font-mono text-[15px] font-semibold" style={{ color: "#EAF0FA" }}>3 yrs</b> cutoff data</span>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            {errors.root && (
              <p
                ...
                style={{ color: "var(--color-ep-red-ink)", background: "var(--color-ep-red-tint)" }}
              >
                {errors.root.message}
              </p>
            )}
