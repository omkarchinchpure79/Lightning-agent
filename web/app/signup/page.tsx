      ...
      >
        ...
        <div className="relative">
          ...
          <h1 className="font-display text-[38px] leading-[1.08] mb-4" style={{ color: "#EAF0FA" }}>
            Stop guessing at<br />
            <span style={{ color: "var(--color-ep-green)" }}>cutoffs.</span> Start predicting.
          </h1>
          <ul className="space-y-2.5 text-[14px]" style={{ color: "#B7C7DE" }}>
        ...
        <div className="relative text-[13px]" style={{ color: "#8FA6C4" }}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-16 relative">
        ...
        <div className="w-full max-w-[380px]">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            {errors.root && (
              <p className="text-xs rounded-[8px] px-3 py-2" style={{ color: "var(--color-ep-red-ink)", background: "var(--color-ep-red-tint)" }}>
                {errors.root.message}
              </p>
            )}
